...
function actualScroll() {
  ...
  if ($(".vs-section").attr("style")) {
    ...
    if (
      ...
      document.getElementById("deco1").style.transform =
        "translateX(" + (150 + Math.round(-actualScroll / 10)) + "px)";
      //            document.getElementById('deco1').style.left = (150 + Math.round(-actualScroll / 10)) + 'px';

      document.getElementById("deco2").style.left =
        750 + Math.round(-actualScroll / 12) + "px";
      document.getElementById("deco3").style.left =
        1650 + Math.round(-actualScroll / 8) + "px";
      document.getElementById("deco4").style.left =
        2250 + Math.round(-actualScroll / 6) + "px";
      document.getElementById("deco5").style.left =
        2750 + Math.round(-actualScroll / 8) + "px";
      document.getElementById("deco6").style.left =
        3350 + Math.round(-actualScroll / 10) + "px";
      document.getElementById("deco7").style.left =
        3950 + Math.round(-actualScroll / 10) + "px";

      document.getElementById("deco1").style.left =
        150 + Math.round(-actualScroll / 10) + "px";
      ...
      document.getElementById("intro").style.transform =
        skewDirection + -speed / 2 + "deg)";
      document.getElementById("contact").style.transform =
        skewDirection + -speed / 2 + "deg)";
      document.getElementById("scrollToCards").style.transform =
        skewDirection + -speed / 2 + "deg)";

      document.getElementById("deco1").style.cssText =
        "transform: skewX(" +
        -speed / 1.2 +
        "deg); left" +
        (150 + Math.round(-actualScroll / 10)) +
        "px";
      document.getElementById("deco2").style.cssText =
        "transform: skewX(" +
        -speed / 1.2 +
        "deg); left" +
        (750 + Math.round(-actualScroll / 12)) +
        "px";
      document.getElementById("deco3").style.cssText =
        "transform: skewX(" +
        -speed / 1.2 +
        "deg); left" +
        (1650 + Math.round(-actualScroll / 8)) +
        "px";
      document.getElementById("deco4").style.cssText =
        "transform: skewX(" +
        -speed / 1.2 +
        "deg); left" +
        (2250 + Math.round(-actualScroll / 6)) +
        "px";
      document.getElementById("deco5").style.cssText =
        "transform: skewX(" +
        -speed / 1.2 +
        "deg); left" +
        (2750 + Math.round(-actualScroll / 8)) +
        "px";
      document.getElementById("deco6").style.cssText =
        "transform: skewX(" +
        -speed / 1.2 +
        "deg); left" +
        (3350 + Math.round(-actualScroll / 10)) +
        "px";
      document.getElementById("deco7").style.cssText =
        "transform: skewX(" +
        -speed / 1.2 +
        "deg); left" +
        (3950 + Math.round(-actualScroll / 10)) +
        "px";
      // ------------------
  ...
  // SKEW CARTES
  document.getElementById("grid_01").style.transform =
    skewDirection + -speed + "deg)";
  document.getElementById("grid_02").style.transform =
    skewDirection + -speed + "deg)";
  document.getElementById("grid_03").style.transform =
    skewDirection + -speed + "deg)";
  document.getElementById("grid_04").style.transform =
    skewDirection + -speed + "deg)";
  document.getElementById("grid_05").style.transform =
    skewDirection + -speed + "deg)";
  document.getElementById("grid_06").style.transform =
    skewDirection + -speed + "deg)";
  document.getElementById("grid_07").style.transform =
    skewDirection + -speed + "deg)";
  document.getElementById("grid_08").style.transform =
    skewDirection + -speed + "deg)";
...
class Grid {
  constructor(el) {
    ...
    // The content items.
    this.contents = [];
    Array.from(document.querySelectorAll(".content > .content__item")).forEach(
      contentEl => this.contents.push(new Content(contentEl))
    );
  ...
  initEvents() {
    ...
    document
      ...
      .addEventListener("click", () => this.closeItem());
    document
    ...
    document
      ...
      .addEventListener("click", () => this.closeItem());
    document
      .querySelector("#backHome4")
      .addEventListener("click", () => this.closeItem());
    document
      .querySelector("#backHome5")
      .addEventListener("click", () => this.closeItem());
    document
      .querySelector("#backHome6")
      .addEventListener("click", () => this.closeItem());
    document
      .querySelector("#backHome7")
      .addEventListener("click", () => this.closeItem());
    document
      .querySelector("#backHome8")
      .addEventListener("click", () => this.closeItem());
  ...
  openItem(item) {
    ...
    if (mobile == false) {
      ...
      translationX =
        winsize.width / 2 - (itemDim.left - actualScroll + itemDim.width / 2);
      translationY = 0;
    } else {
      // item.DOM.bg.style.left = `0px`;
      // item.DOM.bg.style.top = `0px`;
